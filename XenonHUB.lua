...
function Update:Window(Config)
	...
	-- Enhanced hover effect for resize button
	...
	-- Enhanced hover effect for settings button
	...
	function CreateCheckbox(title, state, callback)
		...
		-- Enhanced hover effect for checkbox
	...
	function uitab:Tab(text, img)
		...
		-- Enhanced hover effect for tab button
		...
		function main:Seperator(text)
			...
			Sep1.Size = UDim2.new(0.25, 0, 0, 2);
			...
			Sep3.Size = UDim2.new(0.25, 0, 0, 2);
